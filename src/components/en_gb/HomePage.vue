        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
              ...
              <figure>
                <div class="aspect-w-12 aspect-h-7 lg:aspect-none">
                  <g-image
                    ...
                    :src="`${$static.home.intro.cover}?nf_resize=smartcrop&w=576&h=360`"
                    :alt="$static.home.intro.title.en"
                  />
                </div>
              </figure>
          ...
          <div class="mt-8 lg:mt-0">
            <div class="text-base max-w-prose mx-auto lg:max-w-none">
              ...
              <h3 class="mt-2 mb-8 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-5xl sm:pr-10">
                {{ $static.home.intro.title.en }}
              </h3>
            </div>
            <div class="mt-5 prose prose-yellow lg:text-lg lg-text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
              <p>
                {{ $static.home.intro.description.en }}
              </p>
            </div>
      ...
      <div class="relative max-w-7xl mx-auto mb-16">
        <div class="text-center">
          <h2 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl">
            {{ $static.home.productsHeading.title.en }}
          </h2>
          <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
            {{ $static.home.productsHeading.description.en }}
          </p>
        </div>
      </div>
      <VueSlickCarousel
        ...
        <div class="h-full w-full xl:grid xl:grid-cols-2">
          <div class="h-full xl:relative xl:col-start-2">
            <g-image
              ...
              alt="$static.home.qualitySection.title.en"
            />
            <g-image
            ...
            <div
              aria-hidden="true"
              class="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-white xl:inset-y-0 xl:left-0 xl:h-full xl:w-full xl:bg-gradient-to-r"
            />
          </div>
        </div>
      </div>
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
        <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24 lg:pr-8">
          ...
          <p class="mt-3 text-3xl font-extrabold text-gray-900">
            {{ $static.home.qualitySection.title.en }}
          </p>
          <p class="mt-5 text-lg text-gray-700">
            {{ $static.home.qualitySection.description.en }}
          </p>
          <div class="flex rounded-md shadow w-32 mt-8">
            <g-link
              :to="$tp('/quality/')"
      ...
      <div class="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div class="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
          <div class="lg:col-span-1 flex items-center justify-center lg:justify-start">
            <h2 class="text-center lg:text-left text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Our values and qualities
            </h2>
          </div>
          <dl class="lg:mt-10 space-y-10 sm:space-y-0 grid grid-cols-2 lg:grid-cols-4 sm:gap-x-10 sm:gap-y-10 lg:mt-0 lg:col-span-2">
            <div class="flex flex-col items-center justify-end">
              ...
              <div class="mt-5">
                <dt class="text-xl text-center leading-6 font-medium text-gray-900">
                  {{ $static.home.values.valueone.en }}
                </dt>
              </div>
            </div>
            ...
            <div class="flex flex-col items-center justify-end">
              ...
              <div class="mt-5">
                <dt class="text-xl text-center leading-6 font-medium text-gray-900">
                  {{ $static.home.values.valuetwo.en }}
                </dt>
              </div>
            </div>
            ...
            <div class="flex flex-col items-center justify-end">
              ...
              <div class="mt-5">
                <dt class="text-xl text-center leading-6 font-medium text-gray-900">
                  {{ $static.home.values.valuethree.en }}
                </dt>
              </div>
            </div>
            ...
            <div class="flex flex-col items-center justify-end">
              ...
              <div class="mt-5">
                <dt class="text-xl text-center leading-6 font-medium text-gray-900">
                  {{ $static.home.values.valuefour.en }}
                </dt>
              </div>
            </div>
          </dl>
...
import ProductCard from '~/components/en_gb/ProductCard.vue'
